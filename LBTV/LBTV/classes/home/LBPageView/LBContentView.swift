...
@objc protocol LBContentViewDelegate : class {
    func contentView(_ contentView : LBContentView, progress : CGFloat, sourceIndex : Int, targetIndex : Int)
    
    @objc optional func contentViewEndScroll(_ contentView : LBContentView)
}

private let LBContentCellID = "LBContentCellID"
...
class LBContentView: UIView {
    ...
    fileprivate lazy var collectionView : UICollectionView = {
        ...
        collectionView.register(UICollectionViewCell.self, forCellWithReuseIdentifier: LBContentCellID)
...
extension LBContentView : UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: LBContentCellID, for: indexPath)
